...
```sh
  cd my-folder
  git clone https://github.com/mohametalmeari/create-react-app-cli.git
```
...
> The Todos List website will contain more animations in the future, providing a fully responsive design for an optimal user experience. Additionally, there will be more pages to enhance the functionality and usability of the website.
...
- **How to build Todos List?**

  - Follow the steps in this https://github.com/microverseinc/curriculum-react-redux/blob/main/math-magicians/exercises/react_tutorial.md
